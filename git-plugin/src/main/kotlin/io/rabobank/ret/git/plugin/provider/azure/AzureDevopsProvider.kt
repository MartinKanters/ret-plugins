...
class AzureDevopsProvider(
    ...
    override fun getPullRequestById(
        repositoryName: String,
        id: String,
    ) = azureDevopsClient.getPullRequestById(
        id,
    ).toGenericDomain()
    ...
    override fun createPullRequest(
        ...
        val creationDTO =
            CreatePullRequest("refs/heads/$sourceRefName", "refs/heads/$targetRefName", title, description)
