...
class TestUrlFactory(private val domain: String) : GitUrlFactory {
    ...
    override fun pullRequest(
        ...
        pullRequestId: String,) = "$domain/pullrequest/$repositoryName/$pullRequestId".toURL()
    override fun pullRequestCreate(repositoryName: String, targetRef: String, sourceRef: String?,
